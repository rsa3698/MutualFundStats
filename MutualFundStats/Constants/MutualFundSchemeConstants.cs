namespace MutualFundStats.Constants
{
    public class MutualFundSchemeConstants
    {
        public static Dictionary<string, int> schemeDictionary = new Dictionary<string, int>
        {
            { "Overnight Fund", 1 },
            { "Liquid Fund", 2 },
